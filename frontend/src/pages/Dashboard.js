            ...
            <div className="complaint-boxes" style={{ display: 'flex', flexWrap: 'wrap', gap: '20px' }}>
              {complaints.map((c, index) => (
                <div key={c._id} className="complaint-card" style={{ border: '1px solid #ccc', borderRadius: '8px', padding: '20px', width: '300px' }}>
                  ...
                  <button type="button" className="btn-primary" onClick={() => setActiveBox(index)}>Message</button>
                  {activeBox === index && (
                    <div className="message-box">
                      ...
                      />
                      <button type="button" className="btn-secondary" onClick={() => handleSendMessage(c._id)}>Send</button>
                    </div>
                  )}
                </div>
              ))}
